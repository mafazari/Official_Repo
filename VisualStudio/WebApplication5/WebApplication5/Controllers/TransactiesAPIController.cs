...
{
    public class TransactiesAPIController : ApiController
    {
        private BankContext db = new BankContext();

        // GET: api/TransactiesAPI
        public IQueryable<Transactie> GetTransacties()
        {
            return db.Transacties;
        }

        // GET: api/TransactiesAPI/5
